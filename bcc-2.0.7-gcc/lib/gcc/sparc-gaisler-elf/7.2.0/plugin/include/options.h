...
#endif
#ifdef GENERATOR_FILE
extern int flag_debug_canonical_path;
#else
  int x_flag_debug_canonical_path;
#define flag_debug_canonical_path global_options.x_flag_debug_canonical_path
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern enum processor_type sparc_cpu_and_features;
#else
  enum processor_type x_sparc_cpu_and_features;
...
#endif
#ifdef GENERATOR_FILE
extern int sparc_fix_lost_divsqrt;
#else
  int x_sparc_fix_lost_divsqrt;
...
#else
  enum processor_type x_sparc_cpu;
...
enum opt_code
{
  ...
  OPT_fdce = 567,                            /* -fdce */
  OPT_fdebug_canonical_path = 568,           /* -fdebug-canonical-path */
  ...
  OPT_m32 = 1151,                            /* -m32 */
  OPT_m64 = 1152,                            /* -m64 */
  OPT_mapp_regs = 1153,                      /* -mapp-regs */
  OPT_mcbcond = 1154,                        /* -mcbcond */
  OPT_mcmodel_ = 1155,                       /* -mcmodel= */
  OPT_mcpu_ = 1156,                          /* -mcpu= */
  OPT_mdebug_ = 1157,                        /* -mdebug= */
  OPT_mfaster_structs = 1158,                /* -mfaster-structs */
  OPT_mfix_at697f = 1159,                    /* -mfix-at697f */
  OPT_mfix_b2bst = 1160,                     /* -mfix-b2bst */
  OPT_mfix_gr712rc = 1161,                   /* -mfix-gr712rc */
  OPT_mfix_tn0013 = 1162,                    /* -mfix-tn0013 */
  OPT_mfix_ut699 = 1163,                     /* -mfix-ut699 */
  OPT_mfix_ut700 = 1164,                     /* -mfix-ut700 */
  OPT_mflat = 1165,                          /* -mflat */
  OPT_mfmaf = 1166,                          /* -mfmaf */
  OPT_mfpu = 1167,                           /* -mfpu */
  OPT_mfsmuld = 1168,                        /* -mfsmuld */
  OPT_mhard_float = 1169,                    /* -mhard-float */
  OPT_mhard_quad_float = 1170,               /* -mhard-quad-float */
  OPT_mlra = 1171,                           /* -mlra */
  OPT_mmemory_model_ = 1172,                 /* -mmemory-model= */
  OPT_mpopc = 1173,                          /* -mpopc */
  OPT_mptr32 = 1174,                         /* -mptr32 */
  OPT_mptr64 = 1175,                         /* -mptr64 */
  OPT_mrelax = 1176,                         /* -mrelax */
  OPT_msoft_float = 1177,                    /* -msoft-float */
  OPT_msoft_quad_float = 1178,               /* -msoft-quad-float */
  OPT_mstack_bias = 1179,                    /* -mstack-bias */
  OPT_mstd_struct_return = 1180,             /* -mstd-struct-return */
  OPT_msubxc = 1181,                         /* -msubxc */
  OPT_mtune_ = 1182,                         /* -mtune= */
  OPT_munaligned_doubles = 1183,             /* -munaligned-doubles */
  OPT_muser_mode = 1184,                     /* -muser-mode */
  OPT_mv8plus = 1185,                        /* -mv8plus */
  OPT_mvis = 1186,                           /* -mvis */
  OPT_mvis2 = 1187,                          /* -mvis2 */
  OPT_mvis3 = 1188,                          /* -mvis3 */
  OPT_mvis4 = 1189,                          /* -mvis4 */
  OPT_mvis4b = 1190,                         /* -mvis4b */
  OPT_n = 1191,                              /* -n */
  ...
  OPT_qnano = 1220,                          /* -qnano */
  OPT_qsvt = 1221,                           /* -qsvt */
  OPT_quiet = 1222,                          /* -quiet */
  OPT_r = 1223,                              /* -r */
  OPT_remap = 1224,                          /* -remap */
  OPT_s = 1225,                              /* -s */
  OPT_save_temps = 1226,                     /* -save-temps */
  OPT_save_temps_ = 1227,                    /* -save-temps= */
  OPT_shared = 1228,                         /* -shared */
  OPT_shared_libgcc = 1229,                  /* -shared-libgcc */
  /* OPT_specs = 1230, */                    /* -specs */
  OPT_specs_ = 1231,                         /* -specs= */
  OPT_static = 1232,                         /* -static */
  OPT_static_libasan = 1233,                 /* -static-libasan */
  OPT_static_libgcc = 1234,                  /* -static-libgcc */
