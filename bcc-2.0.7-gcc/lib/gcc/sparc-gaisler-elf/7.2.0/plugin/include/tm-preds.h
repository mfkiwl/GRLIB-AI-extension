/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/opt/bcc-2.0.7-gcc/src/bcc-2.0.7/gcc/gcc/config/sparc/sparc.md'.  */
...
extern int imm5_operand_dictunpack8 (rtx, machine_mode);
extern int imm5_operand_dictunpack16 (rtx, machine_mode);
extern int imm5_operand_dictunpack32 (rtx, machine_mode);
extern int imm2_operand (rtx, machine_mode);
