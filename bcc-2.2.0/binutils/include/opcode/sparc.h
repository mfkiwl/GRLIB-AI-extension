...
#define SD1(x)      (((x) & 0x1f) << 5)  /* SIMD first stage OP marcmod*/
#define SD2(x)      (((x) & 0x7) << 10)   /* SIMD second stage OP marcmod*/
...
#define F1(x)		(OP (x))
#define AINI(x, y)  (OP (2) | OP3(0x09) | SD1(x) | SD2(y)) /* Format AI no imm insns marcmod */
#define AI(x, y, z) (OP (2) | OP3(0x09) | SD1(x) | SD2(y) | F3I(z)) /* Format AI insns marcmod */
#define NAINI(x, y) (OP (~2) | OP3(~0x09) | SD1(x) | SD2(y)) /* Format AI no imm insns marcmod */
#define NAI(x, y, z)(OP (~2) | OP3(~0x09) | SD1(x) | SD2(y) | F3I(z)) /* Format AI insns marcmod */
