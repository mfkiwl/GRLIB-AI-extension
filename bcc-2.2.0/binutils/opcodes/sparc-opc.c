...
#define MASK_LEON_AI	SPARC_OPCODE_ARCH_MASK (SPARC_OPCODE_ARCH_LEON_AI)
...
#define HWS_AI HWS_V8 | HWCAP_AISIMD
...
const struct sparc_opcode_arch sparc_opcode_archs[] =
{
  ...
  /* v8 with AI marcmod simd module */
  { "v8ai", MASK_V6 | MASK_V7 | MASK_V8 | MASK_LEON_AI, HWS_AI, 0 },
  { "leon", MASK_V6 | MASK_V7 | MASK_V8 | MASK_LEON, HWS_V8, 0 },
  /* leon with AI marcmod simd module */
  { "leonai", MASK_V6 | MASK_V7 | MASK_V8 | MASK_LEON | MASK_LEON_AI, HWS_AI, 0 },
...
/* Define SIMD insns marcmod */
{ "nop_",      AINI(0, 0),     NAINI(~0, ~0)|RD_G0,   "", 0, HWCAP_AISIMD, 0, v8ai},
{ "pass_",     AINI(0, 0),     NAINI(~0, ~0),   "1,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nop_sum",   AINI(0, 1),     NAINI(~0, ~1),   "1,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nop_max",   AINI(0, 2),     NAINI(~0, ~2),   "1,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nop_min",   AINI(0, 3),     NAINI(~0, ~3),   "1,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nop_xor",   AINI(0, 4),     NAINI(~0, ~4),   "1,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nop_usum",  AINI(0, 5),     NAINI(~0, ~5),   "1,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nop_umax",  AINI(0, 6),     NAINI(~0, ~6),   "1,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nop_umin",  AINI(0, 7),     NAINI(~0, ~7),   "1,d", 0, HWCAP_AISIMD, 0, v8ai},

/*S1 add*/
{ "add_",       AI(1, 0, 0),    NAI(~1, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_",       AI(1, 0, 1),    NAI(~1, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_sum",    AI(1, 1, 0),    NAI(~1, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_sum",    AI(1, 1, 1),    NAI(~1, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_max",    AI(1, 2, 0),    NAI(~1, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_max",    AI(1, 2, 1),    NAI(~1, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_min",    AI(1, 3, 0),    NAI(~1, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_min",    AI(1, 3, 1),    NAI(~1, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_xor",    AI(1, 4, 0),    NAI(~1, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_xor",    AI(1, 4, 1),    NAI(~1, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_usum",   AI(1, 5, 0),    NAI(~1, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_usum",   AI(1, 5, 1),    NAI(~1, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_umax",   AI(1, 6, 0),    NAI(~1, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_umax",   AI(1, 6, 1),    NAI(~1, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_umin",   AI(1, 7, 0),    NAI(~1, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "add_umin",   AI(1, 7, 1),    NAI(~1, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 sub*/
{ "sub_",       AI(2, 0, 0),    NAI(~2, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_",       AI(2, 0, 1),    NAI(~2, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_sum",    AI(2, 1, 0),    NAI(~2, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_sum",    AI(2, 1, 1),    NAI(~2, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_max",    AI(2, 2, 0),    NAI(~2, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_max",    AI(2, 2, 1),    NAI(~2, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_min",    AI(2, 3, 0),    NAI(~2, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_min",    AI(2, 3, 1),    NAI(~2, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_xor",    AI(2, 4, 0),    NAI(~2, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_xor",    AI(2, 4, 1),    NAI(~2, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_usum",   AI(2, 5, 0),    NAI(~2, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_usum",   AI(2, 5, 1),    NAI(~2, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_umax",   AI(2, 6, 0),    NAI(~2, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_umax",   AI(2, 6, 1),    NAI(~2, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_umin",   AI(2, 7, 0),    NAI(~2, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sub_umin",   AI(2, 7, 1),    NAI(~2, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 mul*/
{ "mul_",       AI(3, 0, 0),    NAI(~3, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_",       AI(3, 0, 1),    NAI(~3, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_sum",    AI(3, 1, 0),    NAI(~3, ~1, ~0), "1,2,d", F_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "mul_sum",    AI(3, 1, 1),    NAI(~3, ~1, ~1), "1,X,d", F_ALIAS, HWCAP_AISIMD, 0, v8ai},
...
{ "mul_max",    AI(3, 2, 0),    NAI(~3, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_max",    AI(3, 2, 1),    NAI(~3, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_min",    AI(3, 3, 0),    NAI(~3, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_min",    AI(3, 3, 1),    NAI(~3, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_xor",    AI(3, 4, 0),    NAI(~3, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_xor",    AI(3, 4, 1),    NAI(~3, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_usum",   AI(3, 5, 0),    NAI(~3, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_usum",   AI(3, 5, 1),    NAI(~3, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_umax",   AI(3, 6, 0),    NAI(~3, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_umax",   AI(3, 6, 1),    NAI(~3, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_umin",   AI(3, 7, 0),    NAI(~3, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "mul_umin",   AI(3, 7, 1),    NAI(~3, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 max*/
{ "max_",       AI(5, 0, 0),    NAI(~5, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_",       AI(5, 0, 1),    NAI(~5, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_sum",    AI(5, 1, 0),    NAI(~5, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_sum",    AI(5, 1, 1),    NAI(~5, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_max",    AI(5, 2, 0),    NAI(~5, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_max",    AI(5, 2, 1),    NAI(~5, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_min",    AI(5, 3, 0),    NAI(~5, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_min",    AI(5, 3, 1),    NAI(~5, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_xor",    AI(5, 4, 0),    NAI(~5, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_xor",    AI(5, 4, 1),    NAI(~5, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_usum",   AI(5, 5, 0),    NAI(~5, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_usum",   AI(5, 5, 1),    NAI(~5, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_umax",   AI(5, 6, 0),    NAI(~5, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_umax",   AI(5, 6, 1),    NAI(~5, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_umin",   AI(5, 7, 0),    NAI(~5, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "max_umin",   AI(5, 7, 1),    NAI(~5, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 min*/
{ "min_",       AI(6, 0, 0),    NAI(~6, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_",       AI(6, 0, 1),    NAI(~6, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_sum",    AI(6, 1, 0),    NAI(~6, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_sum",    AI(6, 1, 1),    NAI(~6, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_max",    AI(6, 2, 0),    NAI(~6, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_max",    AI(6, 2, 1),    NAI(~6, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_min",    AI(6, 3, 0),    NAI(~6, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_min",    AI(6, 3, 1),    NAI(~6, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_xor",    AI(6, 4, 0),    NAI(~6, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_xor",    AI(6, 4, 1),    NAI(~6, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_usum",   AI(6, 5, 0),    NAI(~6, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_usum",   AI(6, 5, 1),    NAI(~6, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_umax",   AI(6, 6, 0),    NAI(~6, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_umax",   AI(6, 6, 1),    NAI(~6, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_umin",   AI(6, 7, 0),    NAI(~6, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "min_umin",   AI(6, 7, 1),    NAI(~6, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 and*/
{ "and_",       AI(7, 0, 0),    NAI(~7, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_",       AI(7, 0, 1),    NAI(~7, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_sum",    AI(7, 1, 0),    NAI(~7, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_sum",    AI(7, 1, 1),    NAI(~7, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_max",    AI(7, 2, 0),    NAI(~7, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_max",    AI(7, 2, 1),    NAI(~7, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_min",    AI(7, 3, 0),    NAI(~7, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_min",    AI(7, 3, 1),    NAI(~7, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_xor",    AI(7, 4, 0),    NAI(~7, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_xor",    AI(7, 4, 1),    NAI(~7, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_usum",   AI(7, 5, 0),    NAI(~7, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_usum",   AI(7, 5, 1),    NAI(~7, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_umax",   AI(7, 6, 0),    NAI(~7, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_umax",   AI(7, 6, 1),    NAI(~7, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_umin",   AI(7, 7, 0),    NAI(~7, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "and_umin",   AI(7, 7, 1),    NAI(~7, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 or*/
{ "or_",        AI(8, 0, 0),    NAI(~8, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_",        AI(8, 0, 1),    NAI(~8, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_sum",     AI(8, 1, 0),    NAI(~8, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_sum",     AI(8, 1, 1),    NAI(~8, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_max",     AI(8, 2, 0),    NAI(~8, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_max",     AI(8, 2, 1),    NAI(~8, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_min",     AI(8, 3, 0),    NAI(~8, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_min",     AI(8, 3, 1),    NAI(~8, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_xor",     AI(8, 4, 0),    NAI(~8, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_xor",     AI(8, 4, 1),    NAI(~8, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_usum",    AI(8, 5, 0),    NAI(~8, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_usum",    AI(8, 5, 1),    NAI(~8, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_umax",    AI(8, 6, 0),    NAI(~8, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_umax",    AI(8, 6, 1),    NAI(~8, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_umin",    AI(8, 7, 0),    NAI(~8, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "or_umin",    AI(8, 7, 1),    NAI(~8, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 xor*/
{ "xor_",       AI(9, 0, 0),    NAI(~9, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_",       AI(9, 0, 1),    NAI(~9, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_sum",    AI(9, 1, 0),    NAI(~9, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_sum",    AI(9, 1, 1),    NAI(~9, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_max",    AI(9, 2, 0),    NAI(~9, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_max",    AI(9, 2, 1),    NAI(~9, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_min",    AI(9, 3, 0),    NAI(~9, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_min",    AI(9, 3, 1),    NAI(~9, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_xor",    AI(9, 4, 0),    NAI(~9, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_xor",    AI(9, 4, 1),    NAI(~9, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_usum",   AI(9, 5, 0),    NAI(~9, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_usum",   AI(9, 5, 1),    NAI(~9, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_umax",   AI(9, 6, 0),    NAI(~9, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_umax",   AI(9, 6, 1),    NAI(~9, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_umin",   AI(9, 7, 0),    NAI(~9, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xor_umin",   AI(9, 7, 1),    NAI(~9, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 nand*/
{ "nand_",      AI(10, 0, 0),   NAI(~10, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_",      AI(10, 0, 1),   NAI(~10, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_sum",   AI(10, 1, 0),   NAI(~10, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_sum",   AI(10, 1, 1),   NAI(~10, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_max",   AI(10, 2, 0),   NAI(~10, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_max",   AI(10, 2, 1),   NAI(~10, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_min",   AI(10, 3, 0),   NAI(~10, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_min",   AI(10, 3, 1),   NAI(~10, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_xor",   AI(10, 4, 0),   NAI(~10, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_xor",   AI(10, 4, 1),   NAI(~10, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_usum",  AI(10, 5, 0),   NAI(~10, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_usum",  AI(10, 5, 1),   NAI(~10, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_umax",  AI(10, 6, 0),   NAI(~10, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_umax",  AI(10, 6, 1),   NAI(~10, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_umin",  AI(10, 7, 0),   NAI(~10, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nand_umin",  AI(10, 7, 1),   NAI(~10, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 nor*/
{ "nor_",      AI(11, 0, 0),   NAI(~11, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_",      AI(11, 0, 1),   NAI(~11, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_sum",   AI(11, 1, 0),   NAI(~11, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_sum",   AI(11, 1, 1),   NAI(~11, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_max",   AI(11, 2, 0),   NAI(~11, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_max",   AI(11, 2, 1),   NAI(~11, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_min",   AI(11, 3, 0),   NAI(~11, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_min",   AI(11, 3, 1),   NAI(~11, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_xor",   AI(11, 4, 0),   NAI(~11, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_xor",   AI(11, 4, 1),   NAI(~11, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_usum",  AI(11, 5, 0),   NAI(~11, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_usum",  AI(11, 5, 1),   NAI(~11, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_umax",  AI(11, 6, 0),   NAI(~11, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_umax",  AI(11, 6, 1),   NAI(~11, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_umin",  AI(11, 7, 0),   NAI(~11, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "nor_umin",  AI(11, 7, 1),   NAI(~11, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 xnor*/
{ "xnor_",      AI(12, 0, 0),   NAI(~12, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_",      AI(12, 0, 1),   NAI(~12, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_sum",   AI(12, 1, 0),   NAI(~12, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_sum",   AI(12, 1, 1),   NAI(~12, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_max",   AI(12, 2, 0),   NAI(~12, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_max",   AI(12, 2, 1),   NAI(~12, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_min",   AI(12, 3, 0),   NAI(~12, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_min",   AI(12, 3, 1),   NAI(~12, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_xor",   AI(12, 4, 0),   NAI(~12, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_xor",   AI(12, 4, 1),   NAI(~12, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_usum",  AI(12, 5, 0),   NAI(~12, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_usum",  AI(12, 5, 1),   NAI(~12, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_umax",  AI(12, 6, 0),   NAI(~12, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_umax",  AI(12, 6, 1),   NAI(~12, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_umin",  AI(12, 7, 0),   NAI(~12, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "xnor_umin",  AI(12, 7, 1),   NAI(~12, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 sadd*/
{ "sadd_",      AI(13, 0, 0),   NAI(~13, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_",      AI(13, 0, 1),   NAI(~13, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_sum",   AI(13, 1, 0),   NAI(~13, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_sum",   AI(13, 1, 1),   NAI(~13, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_max",   AI(13, 2, 0),   NAI(~13, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_max",   AI(13, 2, 1),   NAI(~13, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_min",   AI(13, 3, 0),   NAI(~13, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_min",   AI(13, 3, 1),   NAI(~13, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_xor",   AI(13, 4, 0),   NAI(~13, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_xor",   AI(13, 4, 1),   NAI(~13, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_usum",  AI(13, 5, 0),   NAI(~13, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_usum",  AI(13, 5, 1),   NAI(~13, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_umax",  AI(13, 6, 0),   NAI(~13, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_umax",  AI(13, 6, 1),   NAI(~13, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_umin",  AI(13, 7, 0),   NAI(~13, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sadd_umin",  AI(13, 7, 1),   NAI(~13, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 ssub*/
{ "ssub_",      AI(14, 0, 0),   NAI(~14, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_",      AI(14, 0, 1),   NAI(~14, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_sum",   AI(14, 1, 0),   NAI(~14, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_sum",   AI(14, 1, 1),   NAI(~14, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_max",   AI(14, 2, 0),   NAI(~14, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_max",   AI(14, 2, 1),   NAI(~14, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_min",   AI(14, 3, 0),   NAI(~14, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_min",   AI(14, 3, 1),   NAI(~14, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_xor",   AI(14, 4, 0),   NAI(~14, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_xor",   AI(14, 4, 1),   NAI(~14, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_usum",  AI(14, 5, 0),   NAI(~14, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_usum",  AI(14, 5, 1),   NAI(~14, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_umax",  AI(14, 6, 0),   NAI(~14, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_umax",  AI(14, 6, 1),   NAI(~14, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_umin",  AI(14, 7, 0),   NAI(~14, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ssub_umin",  AI(14, 7, 1),   NAI(~14, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 smul*/
{ "smul_",      AI(15, 0, 0),   NAI(~15, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_",      AI(15, 0, 1),   NAI(~15, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_sum",   AI(15, 1, 0),   NAI(~15, ~1, ~0), "1,2,d", F_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "smul_sum",   AI(15, 1, 1),   NAI(~15, ~1, ~1), "1,X,d", F_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "sdot",       AI(15, 1, 0),   NAI(~15, ~1, ~0), "1,2,d", F_PREF_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "sdot",       AI(15, 1, 1),   NAI(~15, ~1, ~1), "1,X,d", F_PREF_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "smul_max",   AI(15, 2, 0),   NAI(~15, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_max",   AI(15, 2, 1),   NAI(~15, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_min",   AI(15, 3, 0),   NAI(~15, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_min",   AI(15, 3, 1),   NAI(~15, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_xor",   AI(15, 4, 0),   NAI(~15, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_xor",   AI(15, 4, 1),   NAI(~15, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_usum",  AI(15, 5, 0),   NAI(~15, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_usum",  AI(15, 5, 1),   NAI(~15, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_umax",  AI(15, 6, 0),   NAI(~15, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_umax",  AI(15, 6, 1),   NAI(~15, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_umin",  AI(15, 7, 0),   NAI(~15, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "smul_umin",  AI(15, 7, 1),   NAI(~15, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 movb*/
{ "merg_",      AI(16, 0, 0),   NAI(~16, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_",      AI(16, 0, 1),   NAI(~16, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_sum",   AI(16, 1, 0),   NAI(~16, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_sum",   AI(16, 1, 1),   NAI(~16, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_max",   AI(16, 2, 0),   NAI(~16, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_max",   AI(16, 2, 1),   NAI(~16, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_min",   AI(16, 3, 0),   NAI(~16, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_min",   AI(16, 3, 1),   NAI(~16, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_xor",   AI(16, 4, 0),   NAI(~16, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_xor",   AI(16, 4, 1),   NAI(~16, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_usum",  AI(16, 5, 0),   NAI(~16, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_usum",  AI(16, 5, 1),   NAI(~16, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_umax",  AI(16, 6, 0),   NAI(~16, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_umax",  AI(16, 6, 1),   NAI(~16, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_umin",  AI(16, 7, 0),   NAI(~16, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "merg_umin",  AI(16, 7, 1),   NAI(~16, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 shift*/
{ "shft_",      AI(17, 0, 0),   NAI(~17, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_",      AI(17, 0, 1),   NAI(~17, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_sum",   AI(17, 1, 0),   NAI(~17, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_sum",   AI(17, 1, 1),   NAI(~17, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_max",   AI(17, 2, 0),   NAI(~17, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_max",   AI(17, 2, 1),   NAI(~17, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_min",   AI(17, 3, 0),   NAI(~17, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_min",   AI(17, 3, 1),   NAI(~17, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_xor",   AI(17, 4, 0),   NAI(~17, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_xor",   AI(17, 4, 1),   NAI(~17, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_usum",  AI(17, 5, 0),   NAI(~17, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_usum",  AI(17, 5, 1),   NAI(~17, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_umax",  AI(17, 6, 0),   NAI(~17, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_umax",  AI(17, 6, 1),   NAI(~17, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_umin",  AI(17, 7, 0),   NAI(~17, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "shft_umin",  AI(17, 7, 1),   NAI(~17, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 umul*/
{ "umul_",      AI(19, 0, 0),   NAI(~19, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_",      AI(19, 0, 1),   NAI(~19, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_sum",   AI(19, 1, 0),   NAI(~19, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_sum",   AI(19, 1, 1),   NAI(~19, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_max",   AI(19, 2, 0),   NAI(~19, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_max",   AI(19, 2, 1),   NAI(~19, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_min",   AI(19, 3, 0),   NAI(~19, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_min",   AI(19, 3, 1),   NAI(~19, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_xor",   AI(19, 4, 0),   NAI(~19, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_xor",   AI(19, 4, 1),   NAI(~19, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_usum",  AI(19, 5, 0),   NAI(~19, ~5, ~0), "1,2,d", F_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "umul_usum",  AI(19, 5, 1),   NAI(~19, ~5, ~1), "1,X,d", F_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "udot",       AI(19, 5, 0),   NAI(~19, ~5, ~0), "1,2,d", F_PREF_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "udot",       AI(19, 5, 1),   NAI(~19, ~5, ~1), "1,X,d", F_PREF_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "umul_umax",  AI(19, 6, 0),   NAI(~19, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_umax",  AI(19, 6, 1),   NAI(~19, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_umin",  AI(19, 7, 0),   NAI(~19, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umul_umin",  AI(19, 7, 1),   NAI(~19, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 umax*/
{ "umax_",      AI(21, 0, 0),   NAI(~21, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_",      AI(21, 0, 1),   NAI(~21, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_sum",   AI(21, 1, 0),   NAI(~21, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_sum",   AI(21, 1, 1),   NAI(~21, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_max",   AI(21, 2, 0),   NAI(~21, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_max",   AI(21, 2, 1),   NAI(~21, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_min",   AI(21, 3, 0),   NAI(~21, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_min",   AI(21, 3, 1),   NAI(~21, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_xor",   AI(21, 4, 0),   NAI(~21, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_xor",   AI(21, 4, 1),   NAI(~21, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_usum",  AI(21, 5, 0),   NAI(~21, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_usum",  AI(21, 5, 1),   NAI(~21, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_umax",  AI(21, 6, 0),   NAI(~21, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_umax",  AI(21, 6, 1),   NAI(~21, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_umin",  AI(21, 7, 0),   NAI(~21, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umax_umin",  AI(21, 7, 1),   NAI(~21, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 umin*/
{ "umin_",      AI(22, 0, 0),   NAI(~22, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_",      AI(22, 0, 1),   NAI(~22, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_sum",   AI(22, 1, 0),   NAI(~22, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_sum",   AI(22, 1, 1),   NAI(~22, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_max",   AI(22, 2, 0),   NAI(~22, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_max",   AI(22, 2, 1),   NAI(~22, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_min",   AI(22, 3, 0),   NAI(~22, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_min",   AI(22, 3, 1),   NAI(~22, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_xor",   AI(22, 4, 0),   NAI(~22, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_xor",   AI(22, 4, 1),   NAI(~22, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_usum",  AI(22, 5, 0),   NAI(~22, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_usum",  AI(22, 5, 1),   NAI(~22, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_umax",  AI(22, 6, 0),   NAI(~22, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_umax",  AI(22, 6, 1),   NAI(~22, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_umin",  AI(22, 7, 0),   NAI(~22, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "umin_umin",  AI(22, 7, 1),   NAI(~22, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 sshift*/
{ "sshft_",      AI(25, 0, 0),   NAI(~25, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_",      AI(25, 0, 1),   NAI(~25, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_sum",   AI(25, 1, 0),   NAI(~25, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_sum",   AI(25, 1, 1),   NAI(~25, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_max",   AI(25, 2, 0),   NAI(~25, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_max",   AI(25, 2, 1),   NAI(~25, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_min",   AI(25, 3, 0),   NAI(~25, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_min",   AI(25, 3, 1),   NAI(~25, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_xor",   AI(25, 4, 0),   NAI(~25, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_xor",   AI(25, 4, 1),   NAI(~25, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_usum",  AI(25, 5, 0),   NAI(~25, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_usum",  AI(25, 5, 1),   NAI(~25, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_umax",  AI(25, 6, 0),   NAI(~25, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_umax",  AI(25, 6, 1),   NAI(~25, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_umin",  AI(25, 7, 0),   NAI(~25, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "sshft_umin",  AI(25, 7, 1),   NAI(~25, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 usadd*/                   
{ "usadd_",      AI(29, 0, 0),   NAI(~29, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_",      AI(29, 0, 1),   NAI(~29, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_sum",   AI(29, 1, 0),   NAI(~29, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_sum",   AI(29, 1, 1),   NAI(~29, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_max",   AI(29, 2, 0),   NAI(~29, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_max",   AI(29, 2, 1),   NAI(~29, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_min",   AI(29, 3, 0),   NAI(~29, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_min",   AI(29, 3, 1),   NAI(~29, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_xor",   AI(29, 4, 0),   NAI(~29, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_xor",   AI(29, 4, 1),   NAI(~29, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_usum",  AI(29, 5, 0),   NAI(~29, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_usum",  AI(29, 5, 1),   NAI(~29, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_umax",  AI(29, 6, 0),   NAI(~29, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_umax",  AI(29, 6, 1),   NAI(~29, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_umin",  AI(29, 7, 0),   NAI(~29, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usadd_umin",  AI(29, 7, 1),   NAI(~29, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 ussub*/                     
{ "ussub_",      AI(30, 0, 0),   NAI(~30, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_",      AI(30, 0, 1),   NAI(~30, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_sum",   AI(30, 1, 0),   NAI(~30, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_sum",   AI(30, 1, 1),   NAI(~30, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_max",   AI(30, 2, 0),   NAI(~30, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_max",   AI(30, 2, 1),   NAI(~30, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_min",   AI(30, 3, 0),   NAI(~30, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_min",   AI(30, 3, 1),   NAI(~30, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_xor",   AI(30, 4, 0),   NAI(~30, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_xor",   AI(30, 4, 1),   NAI(~30, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_usum",  AI(30, 5, 0),   NAI(~30, ~5, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_usum",  AI(30, 5, 1),   NAI(~30, ~5, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_umax",  AI(30, 6, 0),   NAI(~30, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_umax",  AI(30, 6, 1),   NAI(~30, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_umin",  AI(30, 7, 0),   NAI(~30, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "ussub_umin",  AI(30, 7, 1),   NAI(~30, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
/*S1 usmul*/                     
{ "usmul_",      AI(31, 0, 0),   NAI(~31, ~0, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_",      AI(31, 0, 1),   NAI(~31, ~0, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_sum",   AI(31, 1, 0),   NAI(~31, ~1, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_sum",   AI(31, 1, 1),   NAI(~31, ~1, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_max",   AI(31, 2, 0),   NAI(~31, ~2, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_max",   AI(31, 2, 1),   NAI(~31, ~2, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_min",   AI(31, 3, 0),   NAI(~31, ~3, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_min",   AI(31, 3, 1),   NAI(~31, ~3, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_xor",   AI(31, 4, 0),   NAI(~31, ~4, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_xor",   AI(31, 4, 1),   NAI(~31, ~4, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_usum",  AI(31, 5, 0),   NAI(~31, ~5, ~0), "1,2,d", F_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "usmul_usum",  AI(31, 5, 1),   NAI(~31, ~5, ~1), "1,X,d", F_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "usdot",       AI(31, 5, 0),   NAI(~31, ~5, ~0), "1,2,d", F_PREF_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "usdot",       AI(31, 5, 1),   NAI(~31, ~5, ~1), "1,X,d", F_PREF_ALIAS, HWCAP_AISIMD, 0, v8ai},
{ "usmul_umax",  AI(31, 6, 0),   NAI(~31, ~6, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_umax",  AI(31, 6, 1),   NAI(~31, ~6, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_umin",  AI(31, 7, 0),   NAI(~31, ~7, ~0), "1,2,d", 0, HWCAP_AISIMD, 0, v8ai},
{ "usmul_umin",  AI(31, 7, 1),   NAI(~31, ~7, ~1), "1,X,d", 0, HWCAP_AISIMD, 0, v8ai},
