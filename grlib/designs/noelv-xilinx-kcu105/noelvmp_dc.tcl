...
source  compile.dc
analyze -f VHDL -library work rtl/ddr4ram.vhd
analyze -f VHDL -library work rtl/axi_mig4_7series.vhd
analyze -f VHDL -library work rtl/sgmii_kcu105.vhd
analyze -f VHDL -library work config.vhd
analyze -f VHDL -library work ahbrom.vhd
analyze -f VHDL -library work noelvmp.vhd
elaborate noelvmp
