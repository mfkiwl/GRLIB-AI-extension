...
create_project noelv-xilinx-kcu105 ./vivado/noelv-xilinx-kcu105 -part xcku040-ffva1156-2-e -force
...
read_vhdl -library work rtl/axi_mig4_7series.vhd
read_vhdl -library work rtl/sgmii_kcu105.vhd
...
read_xdc ../../boards/xilinx-kcu105-xcku040/xilinx-kcu105-xcku040.xdc
set_property used_in_synthesis true [get_files ../../boards/xilinx-kcu105-xcku040/xilinx-kcu105-xcku040.xdc]
set_property used_in_implementation true [get_files ../../boards/xilinx-kcu105-xcku040/xilinx-kcu105-xcku040.xdc]
...
if {[regexp -nocase {.*board_part.*} [list_property [current_project]]]} {
  ...
  set_property board xilinx.com:kcu105:part0:1.4 [current_project]
}
set_property target_language verilog [current_project]
...
generate_target  all [get_files ./vivado/noelv-xilinx-kcu105/noelv-xilinx-kcu105.srcs/sources_1/ip/mig/mig.xci] -force 
generate_target  all [get_files ./vivado/noelv-xilinx-kcu105/noelv-xilinx-kcu105.srcs/sources_1/ip/mig_cdc/mig_cdc.xci] -force 
generate_target  all [get_files ./vivado/noelv-xilinx-kcu105/noelv-xilinx-kcu105.srcs/sources_1/ip/axi_pipe/axi_pipe.xci] -force 
set_property target_language verilog [current_project]
import_ip -files vivado/sgmii.xci -name sgmii
generate_target  all [get_files ./vivado/noelv-xilinx-kcu105/noelv-xilinx-kcu105.srcs/sources_1/ip/sgmii/sgmii.xci] -force 
import_ip -files vivado/sem_ultra_0.xci -name sem_ultra_0
generate_target  all [get_files ./vivado/noelv-xilinx-kcu105/noelv-xilinx-kcu105.srcs/sources_1/ip/sem_ultra_0/sem_ultra_0.xci] -force 
